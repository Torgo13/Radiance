...
namespace StarterAssets
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private const float _threshold = float.Epsilon; //0.01f;
        ...
        private void GroundedCheck()
        {
            ...
            Vector3 spherePosition = transformHandle.position;
        ...
        private void Move()
        {
            ...
            float currentHorizontalSpeed = velocity2D.magnitude;
            ...
            {
                // move
                Quaternion rotation = transformHandle.rotation;
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            Gizmos.DrawSphere(transformHandle.position + new Vector3(0, -GroundedOffset, 0), GroundedRadius);
        }
    }
}