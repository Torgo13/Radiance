...
namespace UnityStandardAssets.CrossPlatformInput
{
    public abstract class VirtualInput
    {
        ...
        protected readonly Dictionary<string, CrossPlatformInputManager.VirtualAxis> m_VirtualAxes =
            new Dictionary<string, CrossPlatformInputManager.VirtualAxis>();
            // Dictionary to store the name relating to the virtual axes
        protected readonly Dictionary<string, CrossPlatformInputManager.VirtualButton> m_VirtualButtons =
            new Dictionary<string, CrossPlatformInputManager.VirtualButton>();
        protected readonly List<string> m_AlwaysUseVirtual = new List<string>();
        ...
        {
            return m_VirtualAxes.GetValueOrDefault(name);
        }
